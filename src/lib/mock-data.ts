...
export const providers: Provider[] = [
  { id: "1", name: "Marcus Johnson", category: "Electrician", categoryId: "1", rating: 4.9, reviewCount: 87, hourlyRate: 65, experience: 12, location: "Downtown", bio: "Licensed electrician with over a decade of experience in residential and commercial wiring.", skills: ["Wiring", "Panel upgrades", "EV chargers", "Smart home"], availability: "available", verified: true, avatar: "MJ" },
  { id: "2", name: "Sarah Chen", category: "Cleaner", categoryId: "3", rating: 4.8, reviewCount: 124, hourlyRate: 40, experience: 6, location: "Midtown", bio: "Professional cleaning specialist providing eco-friendly deep cleaning services.", skills: ["Deep cleaning", "Move-in/out", "Eco-friendly", "Commercial"], availability: "available", verified: true, avatar: "SC" },
  { id: "3", name: "David Torres", category: "Plumber", categoryId: "2", rating: 4.7, reviewCount: 63, hourlyRate: 70, experience: 15, location: "West Side", bio: "Master plumber specializing in emergency repairs and bathroom renovations.", skills: ["Emergency repair", "Renovation", "Water heaters", "Drain cleaning"], availability: "busy", verified: true, avatar: "DT" },
  { id: "4", name: "Emily Park", category: "Tutor", categoryId: "4", rating: 5.0, reviewCount: 42, hourlyRate: 55, experience: 8, location: "University District", bio: "Certified educator specializing in math and science for all age groups.", skills: ["Mathematics", "Physics", "SAT prep", "AP courses"], availability: "available", verified: true, avatar: "EP" },
  { id: "5", name: "James Miller", category: "Technician", categoryId: "5", rating: 4.6, reviewCount: 91, hourlyRate: 50, experience: 10, location: "Tech Park", bio: "IT professional with expertise in hardware repair and network setup.", skills: ["PC repair", "Networking", "Data recovery", "Smart home"], availability: "available", verified: true, avatar: "JM" },
  { id: "6", name: "Ana Rodriguez", category: "Painter", categoryId: "7", rating: 4.8, reviewCount: 56, hourlyRate: 45, experience: 9, location: "Arts District", bio: "Creative painter bringing life to spaces with beautiful color transformations.", skills: ["Interior", "Exterior", "Decorative", "Wallpaper"], availability: "available", verified: true, avatar: "AR" },
];
